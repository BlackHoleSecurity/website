...
<html>
                            ...
                            <div class="panel-body">
                                <div class="search p bg-light m-b-sm">
                                    <form action="<?php echo site_url(
                                        'backend/comment/results'
                                    ); ?>" method="GET" data-default="150">
                                ...
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation"><a href="<?php echo site_url(
                                            'backend/comment'
                                        ); ?>">All<span class="badge badge-success pull-right m-l-xs"><?php echo $total_all; ?></span></a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?php foreach (
                                            ...
                                            <div class="search-item">
                                                <div class="pull-left m-r-md">
                                                    <a href="javascript:void(0);" class="btn-image" data-comment_id="<?php echo $row->comment_id; ?>" data-name="<?php echo $row->comment_name; ?>" data-email="<?php echo $row->comment_email; ?>">
                                                        <?php if (
                                                            ...
                                                            <img src="<?php echo base_url() .
                                                                'assets/images/' .
                                                                $row->comment_image; ?>" class="img-circle" width="50" height="50" alt="<?php echo $row->comment_name; ?>">
                                                        <?php else: ?>
                                                            <img src="<?php echo base_url() .
                                                                'assets/images/user_blank.png'; ?>" class="img-circle" width="50" alt="<?php echo $row->comment_name; ?>">
                                                        <?php endif; ?>
                                                    </a>
                                                </div>
                                                ...
                                                <h3 class="no-m"><a href="<?php echo site_url(
                                                    'blog/' . $row->post_slug
                                                ); ?>" target="_blank"><?php echo $row->post_title; ?></a></h3>
                                                <a href="javascript:void(0);" class="search-link"><b><?php echo $row->comment_name; ?></b>, <?php echo $row->comment_date; ?></a> <?php if (
    ...
    echo "<span class='label label-danger'>Unpublish</span>";
                                            ...
                                            $result = $this->db->query(
                                                "SELECT comment_id,DATE_FORMAT(comment_date,'%d %M %Y %H:%i') AS comment_date,comment_name,comment_email,comment_message,post_id,post_title,post_slug FROM tbl_comment JOIN tbl_post ON comment_post_id=post_id WHERE comment_parent='$comment_id' ORDER BY comment_id ASC"
                                            );
                                            foreach (
                                                $result->result()
                                                as $row
                                                ...
                                                <div class="col-md-offset-1">
                                                    <div class="search-item">
                                                        <div class="pull-left m-r-md">
                                                            <img src="<?php echo base_url() .
                                                                'assets/images/avatar1.png'; ?>" class="img-circle" width="50" alt="<?php echo $row->comment_name; ?>">
                                                        </div>
                                                        <div class="pull-right m-r-md">
                                                            <div class="btn-group">
                                                              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
