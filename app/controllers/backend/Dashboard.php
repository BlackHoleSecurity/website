...
class Dashboard extends CI_Controller
{
    ...
    function index()
    {
        ...
        if ($chrome_visitors->num_rows() > 0) {
            ...
            $data['chrome_visitor'] =
                ($visitor_chrome / $visitor_this_month) * 100;
        } else {
        ...
        if ($firefox_visitors->num_rows() > 0) {
            ...
            $data['firefox_visitor'] =
                ($visitor_firefox / $visitor_this_month) * 100;
        } else {
        ...
        if ($explorer_visitors->num_rows() > 0) {
            ...
            $data['explorer_visitor'] =
                ($visitor_explorer / $visitor_this_month) * 100;
        } else {
        ...
        if ($safari_visitors->num_rows() > 0) {
            ...
            $data['safari_visitor'] =
                ($visitor_safari / $visitor_this_month) * 100;
        } else {
        ...
        if ($opera_visitors->num_rows() > 0) {
            ...
            $data['opera_visitor'] =
                ($visitor_opera / $visitor_this_month) * 100;
        } else {
        ...
        if ($robot_visitors->num_rows() > 0) {
            ...
            $data['robot_visitor'] =
                ($visitor_robot / $visitor_this_month) * 100;
        } else {
        ...
        if ($other_visitors->num_rows() > 0) {
            ...
            $data['other_visitor'] =
                ($visitor_other / $visitor_this_month) * 100;
        } else {
